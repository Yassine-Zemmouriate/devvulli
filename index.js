  ...
  $(document).ready(function () {
    ...
    tableau.extensions.initializeAsync().then(function () {
      ...
      dashboard.getParametersAsync().then(function (parameters) {
          ...
          const manualBNValue = parameters.find(p => p.name === "manuel_bn");
          const manualReferenceValue = parameters.find(p => p.name === "manuel_ref");
          let worksheet = null;

          if (entryTypeParameter){
            entryTypeParameter.addEventListener(tableau.TableauEventType.ParameterChanged, function(parameterChangedEvent) {
              parameterChangedEvent.getParameterAsync().then((parameter) => {
                const parameterValue = parameter.currentValue.nativeValue;
