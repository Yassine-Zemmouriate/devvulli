    ...
    `;
        ...
        case "Modèle OXY":
          ...
          <div id="templatefnaceveil" >
            ...
            <P class="my-class" style="margin-left: 4.899999999999999mmmm; margin-top: -1mm;">poids du carton: <span style="margin-left:7mm;">{{poidsducarton}}</span></P>
            <p class="my-class" style="margin-left: 5mm; margin-top: -1mm;">dimension du carton:      <SPAN style="margin-left:13.3mm;">{{dimcarton}}</SPAN></p>
